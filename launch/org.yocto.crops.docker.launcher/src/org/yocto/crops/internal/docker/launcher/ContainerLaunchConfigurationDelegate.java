...
public class ContainerLaunchConfigurationDelegate extends GdbLaunchDelegate
	 ...
	 * Override superclass because our gdb is inside the toolchain container
     *
	 */
	@Override
	protected String getGDBVersion(ILaunchConfiguration config) throws CoreException {
		/* TODO:
		 * 1. get toolchain container we are connecting/connected to
		 * 2. make sure it is alive
		 * 3. ask it it's gdb version
		 */
