...
public class ZephyrArchOptionValueHandler implements IManagedOptionValueHandler {

	String defaultValue = null;
	
	public ZephyrArchOptionValueHandler() {
	...
	public boolean handleValue(IBuildObject configuration, IHoldsOptions holder, IOption option, String extraArgument,
			...
			String system_zephyr_arch = null;
			...
			if (store != null) {
				system_zephyr_arch = store.getDefaultString(PreferenceConstants.P_ZEPHYR_ARCH);
			}
			
			defaultValue = system_zephyr_arch;
