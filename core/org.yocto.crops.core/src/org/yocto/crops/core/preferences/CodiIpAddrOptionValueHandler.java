...
public class CodiIpAddrOptionValueHandler implements IManagedOptionValueHandler {

	String defaultValue = null;
	
	public CodiIpAddrOptionValueHandler() {
	...
	public boolean handleValue(IBuildObject configuration, IHoldsOptions holder, IOption option, String extraArgument,
			...
			if (store != null) {
				system_codi_ip_addr = store.getDefaultString(PreferenceConstants.P_CODI_IP_ADDR);
			}	
			defaultValue = system_codi_ip_addr;
